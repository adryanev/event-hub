            ...
            <?= \common\widgets\Menu::widget(
                    [
                        'items' => [
                            ...
                            ['label'=>'Verifkasi Organizer', 'icon'=>'zmdi-file-text','url'=>['/verifikasi-organizer'],'template'=>$controllerName === 'admin'? '<a href="{url}" class="waves-effect active">{icon} {label}</a>': '<a href="{url}" class="waves-effect">{icon} {label}</a>'],
