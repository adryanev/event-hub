            ...
            <?= \common\widgets\Menu::widget(
                    [
                        'items' => [
                            ...
                            ['label'=>'Topik', 'icon'=>'zmdi-view-list','url'=>['/topic'],'template'=>$controllerName === 'topic' ? '<a href="{url}" class="waves-effect active">{icon} {label}</a>': '<a href="{url}" class="waves-effect">{icon} {label}</a>'],
                            ...
                            ['label'=>'Type', 'icon'=>'zmdi-format-list-bulleted','url'=>['/type'],'template'=>$controllerName === 'type' ? '<a href="{url}" class="waves-effect active">{icon} {label}</a>': '<a href="{url}" class="waves-effect">{icon} {label}</a>'],
