...
Yii::setAlias('@adminBaseUrl',"http://admin.event-hub.test");
Yii::setAlias('@organizerBaseUrl',"http://organizer.event-hub.test");
Yii::setAlias('@frontendBaseUrl',"http://event-hub.test");
